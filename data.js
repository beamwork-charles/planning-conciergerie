...
const ABSENCES = {
  ...
  Dynah:   {
    ...
    /* 01-02/08 = samedi/dimanche (off) → non décomptés */
    '2026-08-03': 'CP', '2026-08-04': 'CP', '2026-08-05': 'CP', '2026-08-06': 'CP', '2026-08-07': 'CP',
  ...
  Charles: {
    ...
    // H2 (21/09 → 04/10) : RTT prioritaires car ils expirent au 31/12 (les CP, eux, courent jusqu'au 31/05).
    // Seuls les jours ouvrés sont décomptés (week-ends des 26-27/09 et 03-04/10 exclus).
